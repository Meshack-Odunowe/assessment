        ...
        <div
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              <label
                htmlFor="username"
                className="mb-2 block text-[14px] font-[700] text-[#555555]">
                Username
              </label>
            ...
            <div className="mb-[24px]">
              <label
                htmlFor="password"
                className="mb-2 block text-sm font-[700] text-[#555555]">
                Password
              </label>
              <div className="relative">
                <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
          ...
          <div className="mt-[24px]  mb-[17px] text-sm">
            <span className="text-gray-600">Forgot your Password? </span>
            <Link
              href="/help"
              className="font-[400] text-16px] underline text-[#055DAE] hover:text-blue-500">
              Get Help
            </Link>
          </div>
        </div>

        <footer className="mt-[105px] text-center  font-[300] text-[#75757580] text-[16px]">
          <nav className="mb-4">
          ...
          <p className=" font-[400]  text-[16px] text-[#555555]">
